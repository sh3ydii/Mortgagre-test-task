...
const mortgage_request_dto_1 = require("./dto/mortgage-request.dto");
let MortgageController = class MortgageController {
    constructor(mortgageService) {
        this.mortgageService = mortgageService;
    }
    async mortgageProfiles(data) {
        console.log(data);
...
__decorate([
    ...
    __metadata("design:paramtypes", [mortgage_request_dto_1.MortgageRequestDto]),
    __metadata("design:returntype", Promise)
], MortgageController.prototype, "mortgageProfiles", null);
exports.MortgageController = MortgageController = __decorate([
    (0, common_1.Controller)('mortgage'),
    __metadata("design:paramtypes", [mortgage_service_1.MortgageService])
], MortgageController);
